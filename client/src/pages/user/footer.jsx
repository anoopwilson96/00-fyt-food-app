    ...
    <footer className="footer bg-gray-800 text-white p-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        <nav>
          ...
          <a className="link block mb-2 hover:text-yellow-400 transition-colors duration-300">
            Food Delivery
          </a>
          <a className="link block mb-2 hover:text-yellow-400 transition-colors duration-300">
          ...
          <a className="link block hover:text-yellow-400 transition-colors duration-300">
            Special Offers
          </a>
        </nav>
